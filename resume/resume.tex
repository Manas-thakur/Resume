...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
    {AI Research Intern}{Mar. 2026 -- May 2026}
    {Daegu Catholic University}{Daegu, South Korea -- Onsite}
    \resumeItemListStart
      \resumeItem{Worked on advanced computer vision and anomaly detection architectures including YOLO, ResNet, CNN-based models, and Amazon PatchCore for industrial inspection systems.}
      \resumeItem{Designed, trained, and evaluated deep learning pipelines for high-precision defect detection, anomaly localization, and automated quality inspection on industrial datasets.}
      \resumeItem{Conducted research on next-generation computer vision architectures focused on improving precision, robustness, and reliability for fine-grained industrial anomaly detection tasks.}
      \resumeItem{Performed model experimentation, optimization, and performance evaluation using Python, PyTorch, OpenCV, and modern deep learning frameworks in real-world industrial environments.}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeItem{\textbf{Programming Languages:} Python, SQL, C++, JavaScript, R}

  \resumeItem{\textbf{AI \& Machine Learning:} Deep Learning, Generative AI, Agentic AI Systems, Multi-Agent Workflows, Computer Vision, NLP, Reinforcement Learning, RAG, Fine-Tuning, Anomaly Detection}

  \resumeItem{\textbf{Frameworks \& Libraries:} PyTorch, TensorFlow, Hugging Face Transformers, LangChain, LangGraph, OpenCV, Scikit-learn, FastAPI, YOLOv8}

  \resumeItem{\textbf{Model Architectures:} Transformers, Vision Transformers (ViTs), CNNs, LSTMs, U-Net, CLIP, DINO, ResNet, PatchCore, SAM}

  \resumeItem{\textbf{LLM \& Agentic Systems:} Tool Calling, Function Calling, Prompt Engineering, Context Management, Memory Systems, Workflow Orchestration, Autonomous Agents, Vector Retrieval Pipelines}

  \resumeItem{\textbf{Data Science \& Visualization:} Pandas, NumPy, Matplotlib, Plotly, Streamlit, Jupyter Notebook}

  \resumeItem{\textbf{MLOps \& Infrastructure:} Docker, Git, CI/CD, MLflow, Weights \& Biases, CUDA, NVIDIA Jetson, Linux, GCP, REST APIs}

  \resumeItem{\textbf{Databases \& Vector Stores:} PostgreSQL, MongoDB, Redis, Pinecone, LanceDB, ChromaDB}
