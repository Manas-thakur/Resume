...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    {API.Market}{San Francisco, California, United States -- Remote}
    \resumeItemListStart
      \resumeItem{Designed and deployed multi-agent AI systems to automate tasks involving web content analysis and community engagement.}
      \resumeItem{Leveraged LLM frameworks and retrieval tools to build scalable, context-aware agents for real-world API use cases.}
      \resumeItem{Built supporting microservices and infrastructure for metadata extraction, categorization, and structured content generation.}
    \resumeItemListEnd

  \resumeSubheading
    {AI Engineer Intern}{Jun. 2025 -- Aug. 2025}
    {Noveum AI}{San Francisco, California, United States -- Remote}
    \resumeItemListStart
      \resumeItem{Contributed to the development and evaluation of LLM-driven workflows focused on reasoning, data validation, and prompt optimization.}
      \resumeItem{Worked on AI tooling to streamline dataset processing, improve evaluation metrics, and enhance model alignment.}
      \resumeItem{Collaborated with research engineers to refine experimental pipelines for performance benchmarking.}
    \resumeItemListEnd
